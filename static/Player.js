export class Player {
	...
	updatePosition(game, time) //time is the current time in seconds, from when the game started
	{
		this.time = time;
	...
	shootBall(game) {
		...
		let b = game.balls[this.ball_index];
		b.release();
